export default function StepCard({ title, body, number, children }) {
	return (
		<div className="indicator">
			...
			<div className="card-body bg-base-200 rounded-2xl border-10 shadow-base-200 w-72 md:w-56 lg:w-72 shadow-lg border-base-content/35 hover:scale-110 transition-transform">
